...
export const EVENT_COLORS: EventColor[] = [
  { key: 'slate', name: '슬레이트', bar: '#6b7280', ink: '#ffffff' },
  { key: 'red', name: '레드', bar: '#d1544c', ink: '#ffffff' },
  { key: 'orange', name: '오렌지', bar: '#d97b2e', ink: '#ffffff' },
  { key: 'amber', name: '앰버', bar: '#c99a1e', ink: '#241a00' },
  { key: 'green', name: '그린', bar: '#3f8f5f', ink: '#ffffff' },
  { key: 'teal', name: '틸', bar: '#2f8b86', ink: '#ffffff' },
  { key: 'blue', name: '블루', bar: '#4372b8', ink: '#ffffff' },
  { key: 'violet', name: '바이올렛', bar: '#7a5cc0', ink: '#ffffff' },
];
